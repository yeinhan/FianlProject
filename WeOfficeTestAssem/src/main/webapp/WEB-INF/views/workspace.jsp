    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
          ...
          <div class="contentTopArea" style="width:60%;">
          ...
          <div class="contentTopArea" style="width:40%;">
             <h1 class="h6 mb-1 text-gray-800" style="padding-top:19px; padding-right:35px; font-weight:bold; text-align:right; cursor:pointer;" onclick="history.back();"><i class="fas fa-arrow-left" style="font-size:15px;"></i>&nbsp;&nbsp;BACK</h1>
          </div>
          <br><br><br>
