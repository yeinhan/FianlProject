...
<script src="./resources/resource/js/chat.js"></script>
<script src="./resources/resource/js/app.js"></script>
...
<script type="text/javascript">
	...
	$(function() {
		...
		mBtn.find("header").click(function() {
			$("#test_modal").modal();
